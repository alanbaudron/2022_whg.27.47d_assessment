...
library(FLCore)
#setwd("N:/git_/2019_whg.27.47d_assessment")
...
year<-2022   # assessment, last survey year
datayear<-2021  # catch data
season<-"spring"

taf.bootstrap(clean = FALSE, data = TRUE, software = TRUE) 
