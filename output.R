...
catab<-data.frame(rownames(catab), catab)
...
stockinfo <-stockInfo(StockCode = "whg.27.47d",
            ...
            ContactPerson = "alan.baudron@gov.scot")
...
fishdata$Recruitment <- c(tabsummary$R.age.0[1:(length(tabsummary$R.age.0)-1)],geoMean(tabsummary$R.age.0[25:(length(tabsummary$R.age.0)-1)])) 
