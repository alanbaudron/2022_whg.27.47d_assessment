...
library(lattice)
library(FLCore)
setwd("C:/MY_FILES/STOCK_ASSESSMENT/WHITING_2022/TAF_2022_whg.27.47d_assessment-master_6plusgroup_v2_F25") # Changed the directory
...
legend("topright", legend=c("Landings","Unwanted catch","IBC"),  col=c("black","purple","darkorange"),lwd=3, bty="n" )
dev.off()
...
plot(dweights$Year, dweights$X0*1000, col="magenta", ylim=c(0,850), lwd=1.6, xlab="Year", ylab="Mean Weight (g)", bty="l",type="l", main="Unwanted catch")
...
par(mfrow = c(1,1),cex=1, mar = c(4,4,2,1) + 0.1)
plot(c(1978:year), natmor[,1], col="magenta", ylim=c(0,3), xlab="Year", ylab="Natural mortality (M)",lwd=2,type="l", bty="l")
lines(c(1978:year), natmor[,2], col="red", lwd=2)
lines(c(1978:year), natmor[,3], col="green", lwd=2)
lines(c(1978:year), natmor[,4], col="blue", lwd=2)
lines(c(1978:year), natmor[,5], col="cyan", lwd=2)
lines(c(1978:year), natmor[,6], col="black", lwd=2)
lines(c(1978:year), natmor[,7], col="blueviolet", lwd=2)
...
taf.png("Fig_22_Rec")
recplot(fit,xlab="Year",las=0,addCI=TRUE)
dev.off()
...
with(data,plot(year,mat,type="n",lwd=2,xlim=c(1990,fyear),ylim=c(0,0.7),xaxt="n",yaxt="n",xlab="",ylab=""))
...
colnames(catageplus)<-c("Year","age0","age1","age2","age3","age4","age5","age6","age7","age8","age9","age10","age11","age12","age13","age14","age15","8+")
colnames(latageplus)<-c("Year","age0","age1","age2","age3","age4","age5","age6","age7","age8","age9","age10","age11","age12","age13","age14","age15","8+")
colnames(datageplus)<-c("Year","age0","age1","age2","age3","age4","age5","age6","age7","age8","age9","age10","age11","age12","age13","age14","age15","8+")
colnames(ibcatageplus)<-c("Year","age0","age1","age2","age3","age4","age5","age6","age7","age8","age9","age10","age11","age12","age13","age14","age15","8+")
colnames(wcatchplus)<-c("Year","age0","age1","age2","age3","age4","age5","age6","age7","age8","age9","age10","age11","age12","age13","age14","age15","8+")
colnames(wlandingsplus)<-c("Year","age0","age1","age2","age3","age4","age5","age6","age7","age8","age9","age10","age11","age12","age13","age14","age15","8+")
colnames(wdiscardsplus)<-c("Year","age0","age1","age2","age3","age4","age5","age6","age7","age8","age9","age10","age11","age12","age13","age14","age15","8+")
colnames(wibcplus)<-c("Year","age0","age1","age2","age3","age4","age5","age6","age7","age8","age9","age10","age11","age12","age13","age14","age15","8+")
...
cc[,-1]<-round(cc[,-1])
colnames(cc)<-c("Year", "Catch", "Wanted catch","Unwanted Catch", "IBC")
